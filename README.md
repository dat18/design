...
- unityroomに限定公開すること
- unityroomにゲームに必要な条件を入れること

## スケジュール
- 2/1(金)　日本ゲーム大賞のテーマ発表
- 2/6(水) 企画、素材集め、プロジェクト作成、GitHubへの登録、WebGLビルド、unityroomにアップロード
- 2/8(金) 開発と発表
- 2/10(日) 23:59 公開締め切り
...
- [京都スペシャル3での講演資料](https://mobile.twitter.com/unity_japan/status/1066892801042874368)
...
- 夏休み課題の作品のUnityプロジェクトを仮提出
  - プロジェクトをZIP圧縮
  - `a館3f-6f共用ドライブ`のいつもの場所(`Z:\2018年\ゲーム学科\学生用\gp1\14提出`)に出席番号と名前のフォルダーを作成して、その中にコピーする
...
# 4回目(5/9)
## 内容
- [前回の著作権の復習と仕上げ](https://github.com/dat18/gd/blob/master/04_license.md)
...
- モック画面を作ろう～続き～
  - タイトル画面のラフを考えてみる
  - あるいは
  - ゲーム画面のレイアウトをPhotoshopやPowerpoint、Excelなどを使って、作ってみる
  - あるいは
  - アイコンや、アイテム、キャラクターのサイズ、縦横比などでもよい
